    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            I have a passion for Web and Software Development as well as anything coding related in general. I've always enjoyed solving problems and found 
        ...
        <div className="stage-cube-cont">
          <div className="cubespinner">
            <div className="face1">
              <FontAwesomeIcon icon={faPython} color="#90EE90" />
            </div>
            <div className="face2">
